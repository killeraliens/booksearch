...
class ResultsList extends Component {
  ...
  render() {
    ...
    const cards = noDupes.map(result => <BookCard key={result.id} id={result.id} volumeInfo={result.volumeInfo} selfLink={result.selfLink} showDetails={this.props.setSelected}/>)
